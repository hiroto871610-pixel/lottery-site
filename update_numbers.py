...
<div class="mt-10 px-4 sm:px-0">
    <a href="numbers_detail.html" class="flex items-center justify-center w-full sm:max-w-xs mx-auto bg-slate-800 text-white hover:bg-slate-700 font-bold py-4 px-6 rounded-2xl transition-all duration-300 shadow-lg group">
