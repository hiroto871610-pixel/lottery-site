...
<body>
    ...
    <header>
        <a href="index.html" style="text-decoration: none;">
            ...
            <div style="color: white; font-size: 32px; font-weight: bold; margin-top: 5px; letter-spacing: 1px;">ジャンボ宝くじ結果・売り場検索</div>
        </a>
    </header>
  ...
  <script>(window.adsbyimobile=window.adsbyimobile||[]).push({{pid:84847,mid:592460,asid:1929936,type:"banner",display:"inline",elementid:"im-111a4112bae54171b8c129433281c73c"}})</script>
    ...
    <footer>
        ...
        <p style="margin-top: 10px; color: #64748b;">© 2026 ロト＆ナンバーズ攻略局🎯完全無料のAI予想 All Rights Reserved.</p>
    </footer>
